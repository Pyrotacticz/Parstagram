...
class ComposeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        ivPhoto = view.findViewById<ImageView>(R.id.imageView)
        ...
        view.findViewById<Button>(R.id.btnSubmit).setOnClickListener {
            ...
            if (photoFile != null) {
                ...
                Log.e(MainActivity.TAG, "no photo to send")
                Toast.makeText(requireContext(), "No photo with post", Toast.LENGTH_SHORT).show()
            }
        }
